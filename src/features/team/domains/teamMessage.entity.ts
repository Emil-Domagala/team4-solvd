...
export class TeamMessageEntity {
  ...
  @IsUUID() readonly teamId!: string;
  @IsUUID() readonly authorId!: string | null;
  @IsEnum(TeamMessageType) readonly type!: TeamMessageType;
  @IsString() @MinLength(1) @MaxLength(2000) readonly text!: string;
